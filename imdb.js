...
var moviePromise = d3.csv("imdb.csv")
  ...
  var z = d3.scaleSqrt()
    .domain([d3.min(data, function(d) { return d.Votes; }), 22000000])
    .range([5, 30]);
  ...
  var showTooltip = function(d) {
    ...
    tooltip
      .style("opacity", 1)
      .html("Rating: " + d.Rating+"--->"+d.Title+"("+d.Release+")"+" "+"  "+"Number of Reviews:"+d.Votes)
  ...
  svg.append("g")
    ...
    .append("circle")
      ...
      .attr("r", function (d) { return z(d.Votes); } )
