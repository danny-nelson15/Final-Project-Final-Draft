...
var moviePromise = d3.csv("rotten.csv")
  ...
  var z = d3.scaleSqrt()
    .domain([d3.min(data, function(d) { return d.Reviews; }), 600])
    .range([1, 13]);
  ...
  var showTooltip = function(d) {
    ...
    tooltip
      .style("opacity", 1)
      .html("Rating: " + d.Rating*100+"%"+" "+d.Title+" "+"Number of Reviews:"+d.Reviews+" "+"Rank:"+d.Rank)
  ...
  svg.append("g")
    ...
    .append("circle")
      ...
      .attr("cx", function (d) { return x(d.Rating*100); } )
      .attr("cy", function (d) { return y(d.Year); } )
      .attr("r", function (d) { return z(d.Reviews); } )
